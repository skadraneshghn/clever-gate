...
import { Card, Table, ScrollArea, Box, Pagination, Center, Text, Stack, Group, ThemeIcon } from "@mantine/core";
import { motion } from "framer-motion";
import { AnimatedInbox, AnimatedRefreshCw } from "./AnimatedIcons";
...
export function CgTable<T>({
  ...
  return (
    <Card p="md" radius="lg" withBorder style={{ width: "100%" }}>
      <Stack gap="sm">
        <ScrollArea>
